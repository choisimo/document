...
OUTPUT_ROOT="${1:-${REPO_ROOT}/site/extra}"
...
sync_dir "docker" "docker"
sync_dir "configs" "configs"
sync_dir "project-docs" "project-docs"
sync_dir "legacy" "legacy"
sync_dir "prompt" "prompts-raw"
sync_dir "mcp" "mcp" "--no-links"
sync_dir "memo" "memo"
sync_dir "code/simulator/javascript" "algorithm-simulator"
sync_dir "code/data-structures" "algorithm-code/data-structures"
sync_dir "code/architect-code" "algorithm-code/code"
sync_dir "code/c-lang" "algorithm-code/C-lang"
sync_dir "code/simulator" "algorithm-code/simulator"
sync_file "code/README.md" "algorithm-code/README.md"
sync_file "code/REVIEW_REPORT.md" "algorithm-code/REVIEW_REPORT.md"
