...
> **범위:** 이 문서는 중동의 종교·제국주의·전쟁·혁명·민족주의·강대국 개입을 다룬 여러 첨부 자료를 주제별로 합친 레거시 강의 노트입니다. 원문 전체를 대체하는 백과사전이나 최신 정세 보고서가 아닙니다.
>
> **근거 상태:** 원본 자료 목록, 판본, 페이지 대응표가 이 파일에 남아 있지 않습니다. 따라서 별도 출처가 붙지 않은 본문은 모두 **검증 전 요약**으로 취급합니다. 서술을 사용할 때는 사건명·행위자·기간을 식별하고, 날짜·인구·사상자·영토·국가 승인 수에는 기준 시점과 출처 페이지를 붙입니다.
>
> **판독 규칙:** 확인 가능한 사건은 **사실**, 당사자의 명분이나 발언은 **귀속된 주장**, 인과관계 평가는 **해석**, 수치나 시점이 충돌하는 항목은 **미확정**으로 구분합니다. 현재 정세를 뜻하는 표현은 반드시 기준일을 명시합니다.
>
> **완료 및 되돌림 기준:** 한 항목은 원자료 위치와 신뢰할 수 있는 보조 출처가 연결되고, 상충 자료와 기준 시점이 해소된 뒤에만 검증 완료로 봅니다. 검증이 깨지면 단정문으로 유지하지 않고 **미확정** 상태로 되돌려 원자료를 다시 확인합니다.
...
이슬람은 크게 수니파(Sunni)와 시아파(Shia)로 나뉩니다. 분화의 핵심에는 무함마드 사후 공동체의 정당한 지도권을 둘러싼 견해 차이가 있습니다. 시아 전통은 알리(Ali)와 그의 후손에게 특별한 권위를 부여하며, 세부 교리와 계보는 분파마다 다릅니다. 수니파가 전 세계 무슬림의 다수를 이루고 시아파가 소수를 이룬다는 구분은 널리 쓰이지만, 정확한 인구와 비율은 조사 시점과 분류 기준에 따라 달라집니다. 국가별 분포와 수치는 기준 연도와 출처를 붙여 사용합니다. 종말론과 예배 관행 역시 전통과 법학파에 따라 구분해 서술해야 합니다.

이슬람의 5가지 기둥(Arkan al-Islam)은 핵심 종교 의무로 설명되며, 실제 수행 의무와 방식에는 개인의 조건과 법학 전통에 따른 차이가 있습니다.
...
- **배경**: 1925년 즉위한 레자 샤 팔레비 국왕은 서구 제도를 강하게 신봉했으며, 서구식 군사 교육을 받았습니다. 그는 이란의 봉건적 종교적 관점이 이란의 더딘 발전을 초래했다고 보았고, 종교적 및 전통 복장의 착용을 금지했습니다. 1935년 이란 정부는 외국 정부에 국호를 '페르시아' 대신 '이란'으로 사용하도록 요청했습니다.
...
- **국제적 문제**: 점령지의 지위, 정착촌, 팔레스타인의 국제법상 지위가 주요 쟁점입니다. 2012년 유엔 총회는 팔레스타인에 비회원 옵서버 국가 지위를 부여했습니다. 팔레스타인을 국가로 인정한 회원국 수는 변동하므로 기준일과 유엔 자료를 붙여야 하며, '불법 점령'·'집단 학살' 같은 법적 평가는 해당 결의나 재판 절차와 판단 단계를 특정해 서술합니다.
...
- **3차 알리야 (1919-1923)**: 2차 알리야의 연장선으로 러시아, 폴란드, 루마니아 등에서 이주가 이어졌습니다. 이 문서에 있던 '약 4백만 명'은 다른 알리야 규모와 맞지 않는 **미확정 수치**이므로, 원자료에서 자릿수와 집계 범위를 확인하기 전에는 인용하지 않습니다.
...
- **5차 알리야 (1929-1939)**: 이주 확대에는 유럽의 반유대주의와 나치 집권 등 여러 배경이 있었습니다. 이 문서에 있던 '3천만 명'은 규모 단위가 맞지 않는 **미확정 수치**이므로 원자료 확인 전에는 사용하지 않습니다. 1939년 영국 정부의 백서는 이후 유대인 이민을 제한했습니다.
...
이 문서는 첨부 자료를 합친 초안이며 완전성이나 사실 검증을 증명하지 않습니다. 강의나 평가에 사용할 항목은 원자료의 문서명·페이지와 신뢰할 수 있는 1차 또는 2차 출처를 연결한 뒤 확정합니다.
