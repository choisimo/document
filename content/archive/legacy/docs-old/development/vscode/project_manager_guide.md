# VSCode Project Manager 활용 문서: 사용 방법과 설정 예시

VSCode Project Manager는 여러 프로젝트를 저장하고 빠르게 전환하기 위한 확장 프로그램이다. 여러 프로젝트를 동시에 다루는 개발 환경에서 프로젝트 목록, 태그, Git 저장소 감지, 프로필 연계를 통해 작업 공간을 관리할 수 있다.
