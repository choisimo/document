...
연속 메모리 할당에서 빈 홀(hole) 목록에서 프로세스에게 메모리를 할당할 때 First-fit과 Best-fit 전략(소스 [138] 참조)을 사용할 수 있습니다. 두 전략의 장단점과 평균적으로 더 나은 메모리 공간 활용을 제공하는 전략 및 이유를 설명한다.
해설:
First-fit 전략:
•
...
Best-fit 전략:
•
장점: 프로세스 크기에 맞는 충분히 큰 홀 중 작은 홀을 할당하므로, 할당 후 남는 단편(hole) 크기가 작습니다 [138]. 이는 평균적으로 더 나은 메모리 공간 활용을 제공합니다 [138].
•
