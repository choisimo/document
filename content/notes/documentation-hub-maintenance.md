...
이 노트는 문서 탐색 화면을 개편하면서 이전 홈의 유지보수·학습 내용을 보존한 것이다. 현재 진입점은 [문서 홈](../docs/index.md)이다. 아래 내용은 개편 전 구조를 설명하는 기록으로 읽는다.
...
| 영역 | 진입 문서 | 역할 |
| --- | --- | --- |
| Algorithms | [algorithms/index.md](../docs/algorithms/index.md) | 알고리즘 개념과 구현 패턴 |
| Books | [books/index.md](../docs/books/index.md) | 책 기반 CS 학습 노트 |
| Compiler | [compiler/index.md](../docs/compiler/index.md) | 컴파일러 렉싱과 파싱 |
| Databases | [databases/index.md](../docs/databases/index.md) | DB, JPA, Redis |
| Development | [development/index.md](../docs/development/index.md) | Docker, Git, IDE, 언어 런타임 |
| Extra | [extra/index.md](../docs/extra/index.md) | 보조 리소스와 Docker Compose 컬렉션 |
| Infrastructure | [infrastructure/index.md](../docs/infrastructure/index.md) | 하드웨어, 네트워크, 모니터링, Proxmox, 스토리지 |
| Java | [java/index.md](../docs/java/index.md) | Java 핵심 개념과 메모리 |
| Linux | [linux/index.md](../docs/linux/index.md) | Linux 명령어, 파일시스템, 배포판 |
| Nginx | [nginx/index.md](../docs/nginx/index.md) | Nginx 설정과 배포 |
| OS | [os/index.md](../docs/os/index.md) | 운영체제 개념 |
| Security | [security/index.md](../docs/security/index.md) | SSH, VPN, Zero Trust, 접근 제어 |
| Tools | [tools/index.md](../docs/tools/index.md) | 터미널, 원격 접속, 자동화 도구 |
